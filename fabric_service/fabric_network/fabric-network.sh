...
{
HLF_VERSION=${HLF_VERSION} docker-compose -f test/fixtures/docker-compose-2orgs-4peers-tls.yaml up -d
source venv/bin/activate
...
{
HLF_VERSION=${HLF_VERSION} docker-compose -f test/fixtures/docker-compose-2orgs-4peers-tls.yaml down
}
