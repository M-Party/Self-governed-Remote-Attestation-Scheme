...
import os
import time
cli = client.Client(net_profile="test/fixtures/network.json")
...
'''config_tx_file = 'test/fixtures/e2e_cli/configtx.yaml'
...
if response == True:
    ...
    if 'name' in responses and 'version' in responses and 'policy' in responses and 'data' in responses and 'id' in responses:
        ...
        response = False
    print("Instantiate chaincode in org1:%s" % response)
