...
// WorkerQuotes workerQuoteResParam json object
type WorkerQuotesResParam struct {
...
type WorkerCustomerEnclaves struct {
	CustomerEnclaves map[string]string `json:"customerEnclaves"`
}
